...
import "./BloodAnalisysTableBody.sass";

class BloodAnalisysTableBody extends Component {
            ...
            template = data.map(item => {
                return (
                    <tr key={item.analisy.id}>
                        ...
                        <td>{item.analisy.Rhesus}</td>
                        <td>{item.analisy.Group}</td>
...
BloodAnalisysTableBody.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(BloodAnalisysTableBody);